...
This package follows the `grkstyle` style guide. Please make sure to
...
You can run the following code to trigger interactive tests that ask for
user validation of the output:
