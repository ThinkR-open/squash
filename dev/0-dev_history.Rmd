...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Compile N Qmd to One HTML File",
    Description = "Compile n .qmd (under format revealjs) to one single html file.",
    `Authors@R` = c(
      person("Antoine", "Languillaume", email = "antoine@thinkr.fr", role = c("aut", "cre")),
      person("Colin", "Fay", email = "colin@thinkr.fr", role = c("aut", "cre"))
    )
  )
)
...
# hide readme from build
usethis::use_build_ignore("README.Rmd")
usethis::use_build_ignore("inst/.quarto")
# Code of Conduct
...
#   extra.suggests = c("tools", "testthat", "ggplot2"),
#   update.config = TRUE
#   )

attachment::att_amend_desc(use.config = TRUE)
